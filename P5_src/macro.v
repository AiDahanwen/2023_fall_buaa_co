`define CODE_IDENTIFY   \
	...
	wire swc = R_type & (funct == 6'b001010); \
	...
	wire lhogez = (op == 6'b101010);\
	wire load = lw | lh | lb | lbu | lhu | lhogez; \
	wire half = lh | lhu | sh | lhogez; \
	wire bytes = lb | lbu | sb; \
	/* Branch */ \
	wire beq = (op == 6'b000100); \
	wire bne = (op == 6'b000101); \
	wire bgezal = (op == 6'b000001) && (rtt == 5'b10001); \
	wire bonall = (op == 6'b010101);\
	wire branch = beq | bne | bgezal | bonall; \
	wire branchTwo = beq | bonall; \
	/* Jump */ \
...
`define OP_DEFINE   \
	...
	localparam swc_op = 5'b00101; \
	/* compare_op */ \
	localparam beq_op = 5'b00000; \
	localparam bne_op = 5'b00001; \
	localparam bgezal_op = 5'b00010;\
	localparam bonall_op = 5'b00011; \
	localparam lhogez_op = 5'b00100;
